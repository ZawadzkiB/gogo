---
description: Plan a feature/change — writes an accept-pending plan to .gogo/plans/feature-<slug>/ and stops for your acceptance.
...
2. Create `.gogo/plans/feature-<slug>/`, read the relevant knowledge, analyse the
