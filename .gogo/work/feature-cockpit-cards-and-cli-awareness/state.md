# State — feature `cockpit-cards-and-cli-awareness`
...
- **feature:** cockpit cards & CLI-awareness — on-demand gogo-cli reference + rich board drill-in card
...
- **accepted:** 2026-07-12 (user; D1-D5 all accepted as recommended: D1=A gogo-cli skill · D2=A inline a/K · D3=A inline events tail · D4=A registry+live-tmux · D5=A A→B)
- **branch:** n/a
- **iterations:** plan=1 · implement=3 · review=1 · test=1   <!-- add · uat=N once a UAT round loops back to planning -->
- **resume:** none — shipped to .gogo/changelog/2026-07-12-cockpit-cards-and-cli-awareness/
- **open-decision:** none    <!-- D6 resolved → A (skip); D1..D5 resolved at acceptance -->
