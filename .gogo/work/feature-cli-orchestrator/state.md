# State — feature `cli-orchestrator`
...
- **feature:** CLI process-orchestrator — warm/resumable phase sessions
...
- **created:** 2026-07-10
- **accepted:** 2026-07-10 (user; D1-D6 all accepted as recommended)
- **completed:** 2026-07-10
- **branch:** n/a
- **iterations:** plan=1 · implement=2 · review=2 · test=1   <!-- add · uat=N once a UAT round loops back to planning -->
- **resume:** none — shipped to .gogo/changelog/2026-07-10-cli-orchestrator/
