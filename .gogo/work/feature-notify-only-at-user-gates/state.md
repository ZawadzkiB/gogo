# State — feature `notify-only-at-user-gates`
...
- **branch:** main
- **iterations:** plan=0 · implement=5 · review=3 · test=1   <!-- add · uat=N once a UAT round loops back to planning -->
- **resume:** none — shipped to .gogo/changelog/2026-07-31-notify-only-at-user-gates/           <!-- <phase to re-enter> — <next action> | none -->
