# State — feature `interactive-plan-review`
...
- **feature:** Interactive plan review — two-document plans, a commentable plan page, and the portable planpad tool
...
- **open-decision:** D1-D8 in decisions.md (round-trip mechanism, detail-file placement, tool home/name, diagram-comment granularity, anchoring, one-file-vs-per-doc, trigger, accept-blocking)
