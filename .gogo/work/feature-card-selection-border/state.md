# State — feature `card-selection-border`
...
- **feature:** Border-only card selection — focus stops repainting the card's colours
...
- **created:** 2026-08-02
- **branch:** main
- **iterations:** plan=1 · implement=2 · review=2 · test=1
- **completed:** 2026-08-02
- **resume:** none — shipped to .gogo/changelog/2026-08-02-card-selection-border/
- **open-decision:** none
