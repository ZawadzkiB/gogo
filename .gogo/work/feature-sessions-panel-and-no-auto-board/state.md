# State — feature `sessions-panel-and-no-auto-board`
...
- **feature:** Sessions panel under S, and no auto-opening board on /gogo:done
...
- **created:** 2026-08-01
- **accepted:** 2026-08-01 (user, via /gogo:go acceptance gate)
- **completed:** 2026-08-01
- **branch:** main
- **iterations:** plan=0 · implement=3 · review=2 · test=1   <!-- add · uat=N once a UAT round loops back to planning -->
- **resume:** none — shipped to .gogo/changelog/2026-08-01-sessions-panel-and-no-auto-board/
- **open-decision:** none
